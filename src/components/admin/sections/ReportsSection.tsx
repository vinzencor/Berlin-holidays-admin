...
export const ReportsSection = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      if (paymentMethodFilter !== "all") {
        bookingsQuery = bookingsQuery.eq("payment_method", paymentMethodFilter);
      }
      ...
      // Apply payment method filter if not "all"
      if (paymentMethodFilter !== "all") {
        expensesQuery = expensesQuery.eq("payment_method", paymentMethodFilter);
      }
  ...
  const downloadSalesReport = () => {
    ...
    autoTable(doc, {
      startY: 95,
      head: [['Date', 'Customer', 'Room', 'Amount', 'GST', 'Payment Method', 'Status']],
      body: tableData,
      theme: 'striped',
    ...
    const filterSuffix = paymentMethodFilter !== "all" ? `_${paymentMethodFilter}` : "";
    ...
    <div className="p-3 md:p-6">
      ...
      <Tabs defaultValue="sales" className="space-y-4">
        <div className="overflow-x-auto -mx-3 md:mx-0">
          <TabsList className="grid w-full min-w-[500px] md:min-w-0 grid-cols-5 mx-3 md:mx-0">
